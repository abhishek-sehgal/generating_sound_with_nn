...
class Autoencoder:
    """
    This class represents a Deep Convolutional autoencoder architecture with mirrored encoder and decoder components
    """
    ...
    def save(self, save_folder="."):
        self._create_folder_if_missing(save_folder)
    ...
    def _add_conv_layers(self, encoder_input):
        """
        This method creates all convolutional blocks in encoder.
        """
        x = encoder_input
    ...
    def _add_conv_transpose_layers(self, x):
        """
        Adds conv transpose layers.
        """
        # loop through all the conv layers in reverse order and stop at the first layer
        for layer_index in range(self._num_conv_layers - 1, 0, -1):
    ...
    def _create_folder_if_missing(self, folder):
